...
function displayCurrentSection(event) {
  ...
  if (currentValue === "reading") {
    currentSection.innerHTML = `<div>
    <a href="https://www.goodreads.com/book/show/35036409-my-brilliant-friend?ref=nav_sb_ss_1_19" class="current-button" target="_blank">Reading now: My Brilliant Friend - Elena Ferrante</a>
    <a href="https://www.goodreads.com/book/show/197798168-all-fours?ref=nav_sb_ss_1_9" class="current-button" target="_blank">Recently finished: All Fours - Miranda July</a>
  ...
  if (currentValue === "watching") {
    currentSection.innerHTML = `<div>
    <a href="https://ebird.org/species/perfal/" class="current-button" target="_blank">Recently loved: Peregrine Falcon</a>
    <a href="https://ebird.org/species/phaino" class="current-button" target="_blank">Looking for: Phainopepla</a>
    ...
    Great Blue Heron</a>
    <a href="https://ebird.org/species/greroa/" class="current-button" target="_blank">Favorite of the Year (so far): 
